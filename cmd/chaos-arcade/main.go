...
func main() {
	...
	fs.String("grpc-service-name", "chaos-arcade", "gPRC service name")
	...
	fs.String("ui-message", fmt.Sprintf("greetings from chaos-arcade v%v", version.VERSION), "UI message")
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/ryneal/chaos-arcade/gh-pages/cuddle_clap.gif")
	viper.Set("hostname", hostname)
	viper.Set("version", version.VERSION)
	viper.Set("revision", version.REVISION)
	viper.SetEnvPrefix("chaos-arcade")
